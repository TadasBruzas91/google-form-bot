...
form.fill_form(scraped_data, addresses_from_file, config.form.data_order, config.form.input_titles, config.transaction_setup.age, config.transaction_setup.values_list)
form.close()